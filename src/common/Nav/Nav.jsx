...
return (
<nav className="navbar mx-5 navbar-expand-lg ">
  <div className="container-fluid px-5">
    <a className="navbar-brand fw-bold fs-4 text_owner" href="#">Ahmed <span>mohamed</span></a>
...
<label class="plane-switch">
    <input type="checkbox" onClick={changeMood}/>
    <div>
        <div>
